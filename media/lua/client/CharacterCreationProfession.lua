---@diagnostic disable: duplicate-set-field, undefined-global, redundant-parameter, undefined-field
--***********************************************************
--**                   ROBERT JOHNSON                      **
--***********************************************************
...
--	self:addChild(MainScreen.instance.charCreationHeader);
    ...
    -- -- the favorite food list choice
    self.listboxFavFood = CharacterCreationProfessionListBox:new((w / 3), self.listboxTrait:getY() + self.listboxTrait:getHeight() + traitButtonGap, self.tableWidth, halfListHeight);
...
function CharacterCreationProfession:prerender()
	...
	self:drawTextCentre("Testing!!!1", self.width / 2, self.mainPanel.y - 10 - FONT_HGT_TITLE, 1, 1, 1, 1, UIFont.Title);
